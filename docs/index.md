...
このサイトはWebGLのフレームワーク「[Three.js](https://threejs.org)」の入門サイトです。

このサイトでは、初学者から学べるように基本的な**Three.jsの使い方**から解説しつつ、発展的な内容までまとめています。このサイトを通して、ウェブの3Dのインタラクションデザインについて学んでいきましょう。
...
Three.jsを使って3Dコンテンツを作る準備をしていきましょう。
